...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/abonnement/checkout', [AbonnementController::class, 'checkout']);
      ...
      Route::get('/abonnements/attente', [AbonnementAdminController::class, 'attente']);
    Route::get('/abonnements/valide', [AbonnementAdminController::class, 'valide']);
    Route::get('/abonnements/refuse', [AbonnementAdminController::class, 'refuse']);
    Route::get('/abonnements/expire', [AbonnementAdminController::class, 'expire']);
});

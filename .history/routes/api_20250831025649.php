...
Route::get('/admin/abonnements/valide', [AbonnementController::class, 'valide']);
Route::patch('/admin/abonnements/{id}/resilier', [AbonnementController::class, 'resilier']);
Route::get('/admin/abonnements/refuses', [AbonnementController::class, 'refuses']);
Route::delete('/admin/abonnements/{id}', [AbonnementController::class, 'destroy']);
 Route::get('admin/abonnements/expire', [AbonnementController::class, 'indexExpires']);
    Route::post('admin/abonnements/{id}/relancer', [AbonnementController::class, 'relancer']);
